  ...
  return(
    <>
      ...
      <div className="flex flex-col items-center py-10 w-[304px]">
        ...
        <button 
          type="button"
          className="py-2 px-6 mt-6 bg-zinc-100 dark:bg-zinc-800 rounded-lg border-transparent text-sm leading-6 hover:bg-zinc-200 dark:hover:bg-zinc-600 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-200 dark:focus:ring-offset-zinc-900 focus:ring-brand-500"
